...
SECRET_KEY = 'django-insecure-n-kz&9=hsa&t-2$6_z4wxf*m$%@eq1d)l&+hrta3fwsc8gfs9s'
...
MIDDLEWARE = [
    ...
    "django_browser_reload.middleware.BrowserReloadMiddleware", # 浏览器自动刷新
]
...
CACHES = {
    'default': {
        ...
        'LOCATION': BASE_DIR / 'cache',  # 将缓存文件存储在项目根目录的 django_cache 文件夹中
        'TIMEOUT': 86400,  # 缓存项的过期时间为 24 小时
        'OPTIONS': {
